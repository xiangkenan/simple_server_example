...
# @Synopsis  rabbitmq consumer base class, on_message method should be
# overriden by child class
# @author Ming Gu(guming@ofo.so))
# @version 1.0
# @date 2017-08-24
...
class RabbitMQConsumer(object):
    ...
    def __init__(self, conf_dict, logger):
        ...
        self._url = conf_dict['url']
        self.EXCHANGE = conf_dict['exchange']
        self.EXCHANGE_TYPE = conf_dict['exchange_type']
    ...
    def setup_queue(self, queue_name):
        ...
        self._channel.queue_declare(self.on_queue_declareok, queue_name, durable=self.QUEUE_DURABLE)
    ...
    def process_body(self, body):
        """process logic of the body of message, should be specified after initialization before
        consuming starts
        """
        pass
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        try:
            ...
            self.logger.warning('prcess body and acknowledge_message failed %s', e)
    ...
    def parse_body(self, body):
        s = json.loads(body,encoding="utf8")
        if s.get("body").get("userid") == None:
            return -1
        return s["body"]["userid"]
